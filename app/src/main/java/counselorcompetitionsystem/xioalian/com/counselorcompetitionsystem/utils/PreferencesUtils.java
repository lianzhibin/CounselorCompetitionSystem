package counselorcompetitionsystem.xioalian.com.counselorcompetitionsystem.utils;
...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "competition_system";

    /**
     *
     * @param context
     * @param key The name of the preference to rmove
     * @return True if the value were removed
     */
